> docs for [`pdj_sitegen`](https://github.com/mivanit/pdj-sitegen) v0.0.3
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/__init__.py)

# `pdj_sitegen` { #pdj_sitegen }
...
1. create a config file. For an example, see `<a href="pdj_sitegen/config.html#DEFAULT_CONFIG_YAML">pdj_sitegen.config.DEFAULT_CONFIG_YAML</a>`, or print a copy of it via
```bash
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/__init__.py#L0-L2)
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/build.py)

# `pdj_sitegen.build` { #pdj_sitegen.build }
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/build.py#L0-L624)



### `def should_copy` { #should_copy }
```python
(rel_path: str, include: list[str], exclude: list[str]) -> bool
```


[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/build.py#L49-L77)
...
### `def copy_content_files` { #copy_content_files }
```python
(
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/build.py#L80-L116)
...
### `def split_md` { #split_md }
```python
(content: str) -> tuple[str, str, typing.Literal['yaml', 'json', 'toml']]
```


[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/build.py#L119-L155)
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/build.py#L158-L204)
...
### `def build_document_tree` { #build_document_tree }
```python
(
    content_dir: pathlib._local.Path,
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/build.py#L207-L280)
...
### `def resolve_filter` { #resolve_filter }
```python
(filter_name: str) -> str
```


[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/build.py#L294-L300)
...
### `def process_pandoc_args` { #process_pandoc_args }
```python
(pandoc_args: dict[str, typing.Any]) -> list[str]
```


[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/build.py#L303-L338)
...
### `def dump_intermediate` { #dump_intermediate }
```python
(
    content: str,
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/build.py#L341-L355)


Dump content to an intermediate file if intermediates_dir is specified


### `def convert_single_markdown_file` { #convert_single_markdown_file }
```python
(
    path: str,
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/build.py#L358-L450)




### `def convert_markdown_files` { #convert_markdown_files }
```python
(
    docs: dict[str, dict[str, typing.Any]],
    jinja_env: jinja2.environment.Environment,
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/build.py#L453-L504)
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/build.py#L507-L588)
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/build.py#L591-L621)
...
### `def read_data_file` { #read_data_file }
```python
(
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/config.py#L28-L49)


read a file from any of json, yaml, or toml


### `def emit_data_file` { #emit_data_file }
```python
(data: dict[str, typing.Any], fmt: Literal['yaml', 'json', 'toml']) -> str
```


[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/config.py#L52-L62)


emit a file as json or yaml


### `def save_data_file` { #save_data_file }
```python
(
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/config.py#L65-L79)
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/config.py#L92-L157)
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/config.py#L123-L134)


Load Config from a dictionary.


### `def serialize` { #Config.serialize }
```python
(self) -> dict[str, typing.Any]
```


[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/config.py#L136-L147)
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/config.py#L149-L151)




### `def as_str` { #Config.as_str }
```python
(self, fmt: Literal['yaml', 'json', 'toml']) -> str
```


[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/config.py#L153-L154)
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/config.py#L156-L157)
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/consts.py)

# `pdj_sitegen.consts` { #pdj_sitegen.consts }

type definitions, format maps and parsers, and frontmatter regex

[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/consts.py#L0-L44)
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/exceptions.py)

# `pdj_sitegen.exceptions` { #pdj_sitegen.exceptions }

`SplitMarkdownError` and `RenderError` exceptions

[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/exceptions.py#L0-L73)



### `class SplitMarkdownError(builtins.Exception):` { #SplitMarkdownError }

[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/exceptions.py#L8-L11)
...
### `class ConversionError(builtins.Exception):` { #ConversionError }

[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/exceptions.py#L14-L17)
...
### `class RenderError(builtins.Exception):` { #RenderError }

[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/exceptions.py#L20-L61)


error while rendering template


### `RenderError` { #RenderError.__init__ }
```python
(
    message: str,
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/exceptions.py#L23-L38)
...
### `class MultipleExceptions(builtins.Exception):` { #MultipleExceptions }

[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/exceptions.py#L64-L74)


Common base class for all non-exit exceptions.


### `MultipleExceptions` { #MultipleExceptions.__init__ }
```python
(message: str, exceptions: dict[str, Exception])
```

[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/exceptions.py#L65-L68)
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/filters/__init__.py)

# `pdj_sitegen.filters` { #pdj_sitegen.filters }


[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/filters/__init__.py#L0-L0)
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/filters/csv_code_table.py)

# `pdj_sitegen.filters.csv_code_table` { #pdj_sitegen.filters.csv_code_table }

python pandoc filter replicating [pandoc-csv2table](https://hackage.haskell.org/package/pandoc-csv2table)

By [@mivanit](mivanit.github.io)

[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/filters/csv_code_table.py#L0-L195)
...
### `def emptyblock` { #emptyblock }
```python
() -> list[typing.Any]
```


[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/filters/csv_code_table.py#L23-L24)




### `def Plain_factory` { #Plain_factory }
```python
(val: str) -> dict[str, typing.Any]
```


[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/filters/csv_code_table.py#L27-L34)




### `def table_cell_factory` { #table_cell_factory }
```python
(val: str) -> list[typing.Any]
```


[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/filters/csv_code_table.py#L37-L44)




### `def table_row_factory` { #table_row_factory }
```python
(lst_vals: list[str]) -> list[typing.Any]
```


[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/filters/csv_code_table.py#L47-L48)




### `def header_factory` { #header_factory }
```python
(lst_vals: list[str]) -> list[typing.Any]
```


[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/filters/csv_code_table.py#L51-L55)




### `def body_factory` { #body_factory }
```python
(table_vals: list[list[str]]) -> list[typing.Any]
```


[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/filters/csv_code_table.py#L58-L66)




### `def keyvals_process` { #keyvals_process }
```python
(keyvals: list[tuple[str, str]]) -> dict[str, str]
```


[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/filters/csv_code_table.py#L69-L70)




### `def codeblock_process` { #codeblock_process }
```python
(
    key: str,
    value: Any,
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/filters/csv_code_table.py#L73-L175)




### `def test_filter` { #test_filter }
```python
() -> None
```


[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/filters/csv_code_table.py#L178-L187)
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/filters/csv_code_table.py#L190-L191)
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/filters/links_md2html.py)

# `pdj_sitegen.filters.links_md2html` { #pdj_sitegen.filters.links_md2html }


[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/filters/links_md2html.py#L0-L27)



### `def links_md2html` { #links_md2html }
```python
(key: str, value: Any, format: str, meta: Any) -> typing.Any | None
```


[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/filters/links_md2html.py#L6-L20)
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/filters/links_md2html.py#L23-L24)
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/install_pandoc.py)

# `pdj_sitegen.install_pandoc` { #pdj_sitegen.install_pandoc }

install pandoc using pypandoc

[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/install_pandoc.py#L0-L5)
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/setup_site.py)

# `pdj_sitegen.setup_site` { #pdj_sitegen.setup_site }

CLI for scaffolding a new pdj-sitegen site.

Creates default configuration, templates, and content files to get started quickly.
Run with `python -m <a href="">pdj_sitegen.setup_site</a> [directory]` to scaffold a new site.

[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/setup_site.py#L0-L86)
...
### `def setup_site` { #setup_site }
```python
(root: pathlib._local.Path = PosixPath('.')) -> None
```


[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/setup_site.py#L30-L58)
...
[View Source on GitHub](https://github.com/mivanit/pdj-sitegen/blob/0.0.3/setup_site.py#L61-L83)
